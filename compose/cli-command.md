...
You can install Compose V2 using the per-distro packages using the [per distro repositories](https://docs.docker.com/engine/install/#server) via the `docker-compose-plugin` package.
